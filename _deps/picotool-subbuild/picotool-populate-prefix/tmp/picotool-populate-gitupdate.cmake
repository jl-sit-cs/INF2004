...
execute_process(
  COMMAND "E:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "2.0.0"
  WORKING_DIRECTORY "C:/Users/santa/Desktop/SIT/INF2004/INF2004/_deps/picotool-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/santa/Desktop/SIT/INF2004/INF2004/_deps/picotool-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/santa/Desktop/SIT/INF2004/INF2004/_deps/picotool-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
